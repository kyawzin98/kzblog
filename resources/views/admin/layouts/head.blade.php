...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs4/dt-1.10.18/b-1.5.4/fh-3.1.4/r-2.2.2/sl-1.2.6/datatables.min.css"/>
<!-- Select 2 -->
<link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/css/select2.min.css" rel="stylesheet" />
<!-- using my fonts -->
<link rel="stylesheet" href="{{asset('admin/assets/fonts/myfontscollection/kzfonts.css')}}">
